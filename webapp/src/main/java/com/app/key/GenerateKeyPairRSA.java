...
public class GenerateKeyPairRSA {
	...
	public static void main(String[] args) throws Exception {
		...
		String userId = "centredepouillement@gmail.com";
		...
		try 
		{
		 ...
		 ks.generateKeyPair(keySizeInBits, 
		    ...
		    try {
			    ks.exportPrivateKey("Keys/privatekeyde.key", "centredepouillement@gmail.com", asciiArmor);
			    ks.exportPublicKey("Keys/publickeyde.key", "centredepouillement@gmail.com", asciiArmor);
